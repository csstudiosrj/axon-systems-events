...
export async function POST(request: Request) {
  ...
  // ── Modo: sugestões de pauta (resposta JSON, não streaming) ───────────────
...
Distribua as datas ao longo das próximas 4 semanas. Varie os horários entre 09:00, 12:00 e 18:00.`;
    ...
    try {
      ...
      // Remove possíveis blocos de markdown que o modelo insistir em colocar
  ...
  // ── Modo: geração de conteúdo (streaming SSE) ─────────────────────────────
  ...
  if (mode === "content") {
    ...
    // Prompt sem apresentação pessoal — só o conteúdo
