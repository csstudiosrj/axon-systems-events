...
export default function OrcamentoPDFPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      {/* Injeção de CSS para forçar a impressão perfeita sem margens do navegador e com cores exatas */}
      <style dangerouslySetInnerHTML={{__html: `
        @media print {
          ...
          /* Adiciona uma margem interna segura apenas no papel */
